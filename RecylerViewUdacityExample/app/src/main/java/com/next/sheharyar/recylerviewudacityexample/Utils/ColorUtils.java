package com.next.sheharyar.recylerviewudacityexample.Utils;
...
public class ColorUtils {
     ...
     * {@link com.next.sheharyar.recylerviewudacityexample.Adapters.GreenAdapter}
     * instance was created.
     *
     * This method is used to show how ViewHolders are recycled in a RecyclerViewActivity.
     * At first, the colors will form a nice, consistent gradient. As the
     * RecyclerViewActivity is scrolled, the
     * {@link com.next.sheharyar.recylerviewudacityexample.Adapters.GreenAdapter}'s will be
